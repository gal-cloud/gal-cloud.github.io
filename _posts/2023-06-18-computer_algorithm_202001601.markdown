...
![Alt text](https://drive.google.com/file/d/1fXmOJ3Af8PSfDcGbRtXHII0yCVP0f6V3/view?usp=drive_link)

#### 종속변수 : 미국 천연가스 선물지수인 Bloomberg Natural Gas TR 주가

* (https://kr.investing.com/indices/bbg-natural-gas-tr)
![Alt text](https://drive.google.com/file/d/1xUCul_4CCbCcQpc8YtwlDt7d1RCcHtvn/view?usp=drive_link)

#### 2022.07.14 ~ 2023.06.15 천연가스의 재고량과 천연가스의 선물지수 주가 변동

* (https://gal-cloud.github.io/2023/06/20/2_dimension_dataSet.html)
![Alt text](https://drive.google.com/file/d/1qrL9aWsweqNXga3C8pjL_Tx2FYcuUODx/view?usp=drive_link)

#### 데이터를 x-y 좌표로 시각화 한 형태

![Alt text](https://drive.google.com/file/d/14WODqtf8TxxV_cEuubSTLvpt7rrtGmGr/view?usp=drive_link)
...
![Alt text](https://drive.google.com/file/d/19C8ad5fam5lWGZXZzRV38gP7gqud5XUy/view?usp=drive_link)
* 최적해
* MSE : 78807
* a = 1, b= 532 => y = x + 532
...
![Alt text](https://drive.google.com/file/d/1bSo43l4NWsPR3lQovJG2lDq091lRwgCF/view?usp=drive_link)
